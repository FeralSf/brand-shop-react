			...
			<div className='container-slider'>
				{dataSlider.map((obj, index) => {
					return (
						...
						>
							<img src={`sliderImage/img${index + 1}.jpg`} />
						</div>
					)
				})}
						...
						<div className='product-info__inner'>
							...
							<div className='sort product-info__sort product-info__sort--center'>
								<details className='product-info__sort-toggle'>
									<summary className='product-info__sort-content'>
										CHOOSE COLOR
										<svg
											width='11'
											height='6'
								...
								<details className='sort-toggle product-info__sort-toggle'>
									<summary className='sort-content product-info__sort-content'>
										CHOOSE SIZE
										<svg
											width='11'
											height='6'
							...
							<button className='btn product-info__btn'>
								<svg
									className='product-info__icon-cart product-info__btn-icon-cart'
									width='26'
									height='24'
									viewBox='0 0 32 29'
									xmlns='http://www.w3.org/2000/svg'
